...
logging_helper.setup(args.CHECKPOINT_PATH + 'Results', 'train_log.txt')
...
if args.LEAKY_RELU_TOGGLE is True:
    set_global_mean_std(pos_mean=train_set.x_pos_mean, pos_std=train_set.x_pos_std, neg_mean=train_set.x_neg_mean, neg_std=train_set.x_neg_std)
...
if args.PRE_NET_CHECKPOINT_PATH is not None:
    ...
    if multi_gpu_used == 0:
        ...
        logger.info(f'pre-trained net (QSMnet(+)): multi GPU were used')
